package com.arthe.store.shoppingservice.controller;
...
import com.arthe.store.shoppingservice.service.InvoiceService;
...
public class InvoiceRest {
    ...
    @GetMapping
    public ResponseEntity<List<Invoice>> listAllInvoces(){
